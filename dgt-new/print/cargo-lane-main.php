...
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('cargo-lane-main');
    $is_search = true;
...
<head>
    ...
    <title>Print Cargo Lane <?= $page >= 1 ? " - Page $page" : ''; ?></title>
    <?php
    echo "<script>";
    ...
    <div class="bg-white mt-3">
        <div class="d-flex justify-content-between align-items-center w-100">
            ...
            <div class="d-flex gap-2">
                <div>
                    <button class="btn btn-sm btn-dark" onclick="window.location.href = '/cargo-lane'"><i class="fa fa-arrow-left"></i> Back</button>
                </div>
                <div class="dropdown">

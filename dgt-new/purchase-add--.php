<?php $page_title = 'Purchase Entry [BOOKING]';
$back_page_url = 'purchase-orders';
include("header.php");
$url = "purchase-add";
                    ...
                    <div class="row mt-1 align-items-center">
                        ...
                        <div class="col">
                            <div class="row gx-1 toggleByRoad">
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input id="l_country_road" name="l_country_road" value="<?php echo $l_country_road; ?>"
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input id="l_border_road" name="l_border_road" value="<?php echo $l_border_road; ?>"
                                               type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input id="r_country_road" name="r_country_road" value="<?php echo $r_country_road; ?>"
                                               type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input id="r_border_road" name="r_border_road" value="<?php echo $r_border_road; ?>"
                                               type="text" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="row gx-1 toggleBySea">
                                ...
                                <div class="col-md toggleLoading">
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo $l_country; ?>" type="text" class="form-control" id="l_country"
                                               name="l_country">
                                    </div>
                                </div>
                                <div class="col-md toggleLoading">
                                ...
                                <div class="col-md toggleLoading">
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo $ctr_name; ?>" type="text" class="form-control" id="ctr_name"
                                               name="ctr_name">
                                    </div>
                                </div>
                            </div>
                            <div class="row gx-1 toggleBySea">
                                <div class="col-md-1">
                                    <div class="form-check mt-md-1">
                                        <input type="checkbox" class="form-check-input" id="is_receiving" name="is_receiving"
                                ...
                                <div class="col-md toggleReceiving">
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo $r_country; ?>" type="text" class="form-control" id="r_country"
                                               name="r_country">
                                    </div>
                                </div>
                                <div class="col-md toggleReceiving">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-sm mb-0">
                        ...
                        while ($details = mysqli_fetch_assoc($pur_d_q)) {
                            ...
                            echo '<td><a href="purchase-add?id=' . $purchase_id . '&action=update_details&pd_id=' . $details_id . '">' . goodsName($details['goods_id']) . '</a></td>';
...
if (isset($_POST['deletePDSubmit'])) {
    ...
    $url .= "?id=" . $p_id_delete;
    if ($done) {
        $msg = "Purchase booking details Deleted.";
        $type = "success";
    }
    message($type, $url, $msg);
} ?>
    ...
    function finalAmount() {
        ...
        if ($("#is_qty").prop('checked') == true) {
            ...
            if (!isNaN(rate2) && rate2 !== 0 && !isNaN(amount)) {
                ...
                //final_amount = (operator === '/') ? rate2 / amount : rate2 * amount;

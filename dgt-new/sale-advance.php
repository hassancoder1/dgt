...
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('sale-advance');
    $is_search = true;
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="text-nowrap">
                                    ...
                                    <td class="text-success"><?= round($adv_paid_final); ?></td>
    ...
    <div class="modal-dialog modal-fullscreen -modal-xl -modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">SALE ADVANCE</h5>
...
if (isset($_POST['deletePaymentAndRozSubmit'])) {
    ...
    $url_ = "sale-advance?view=1&p_id=" . $p_id_hidden;
...
if (isset($_POST['transferAdvanceToRem'])) {
    ...
    $msg = 'DB Failed';
    $p_id_hidden = mysqli_real_escape_string($connect, $_POST['p_id_hidden']);
    $data = array('transfer_level' => 4, '`from`' => 'sale-advance');

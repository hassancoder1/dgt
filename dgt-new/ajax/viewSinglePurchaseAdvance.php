                    ...
                    <div class="row align-content-center">
                        <div class="col-10">
                            ...
                            foreach ($adv_paid as $item) {
                                ...
                                echo '<a href="purchase-advance?view=1&p_id=' . $purchase_id . '&purchase_pays_id=' . $item['id'] . '">';
            ...
            <div class="collapse show" id="collapseExample">
                ...
                if ($purchase_pays_id > 0) {
                    ...
                    if (mysqli_num_rows($purchase_paysQ) > 0) {
                        ...
                        $adv_arr = array(
                            'finish' => array('div_class' => 'border border-danger', 'btn_text' => 'Update', 'btn_class' => 'btn-warning', 'back' => '<a href="purchase-advance?view=1&p_id=' . $purchase_id . '">Back</a>', 'purchase_pays_id' => $purchase_pays_id, 'action' => 'update'),

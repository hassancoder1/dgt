        ...
        <div class="row">
            <div class="col-10 order-0 content-column">
                <div class="card mb-2">
                    ...
                    $partial_amount1 = ($percentage / 100) * $total_amount;
                    $partial_amount2 = ($remaining_percentage / 100) * $total_amount;
                    if ($record['from'] === 'purchase-credit') {
                    ...
                    <div class="m-3">
                        ...
                        <table class="table mb-2 table-hover table-sm">
                            <thead>
                                <?php if ($record['from'] !== 'purchase-credit') { ?>
                                    <tr>
                    ...
                    <?php if ($record['from'] === 'purchase-remaining') { ?>
                        <div class="mx-3">
                    ...
                    <?php } else if ($record['from'] === 'purchase-credit') { ?>
                        <div class="mx-3">
                        ...
                        if ($record['khaata_tr1'] != '') {
                            $rozQ = fetch('roznamchaas', array('r_type' => 'Business', 'transfered_from_id' => $record['sr'], 'transfered_from' => 'purchase_' . $record['type']));

    ...
    <div class="row">
        <div class="col-10 order-1 content-column">
            ...
            <div class="row align-content-center">
                <div class="col-10">
                    <?php $adv_paid = saleSpecificData($sale_id, 'adv');
                    foreach ($adv_paid as $item) {
                        ...
                        echo '<a href="sale-advance?view=1&s_id=' . $sale_id . '&sale_pays_id=' . $item['id'] . '">';
                        echo '<b>Dr. A/c.</b>' . $item['dr_khaata_no'] . '</a>';
                        echo '</div>';
                ...
                <div class="col-2">
                    <?php $adv_paid_final = saleSpecificData($sale_id, 'adv_paid_total');
                    $bal = $record['pct_amt'] - $adv_paid_final;
                    echo '<h6 class="text-success mb-0"><b>TOTAL </b>' . round($adv_paid_final) . '</h6>';
            ...
            <div class="collapse show-" id="collapseExample">
                ...
                if ($sale_pays_id > 0) {
                    ...
                    if (mysqli_num_rows($sale_paysQ) > 0) {
                        ...
                        $adv_arr = array(
                            'finish' => array('div_class' => 'border border-danger', 'btn_text' => 'Update', 'btn_class' => 'btn-warning', 'back' => '<a href="sale-advance?view=1&s_id=' . $sale_id . '">Back</a>', 'sale_pays_id' => $sale_pays_id, 'action' => 'update'),
                ...
                <form method="post" onsubmit="return confirm('Are you sure?');"
                    ...
                    <div class="row gx-0">
                        ...
                        <div class="col-md-1 text-end">
                            <button name="tAdvSubmit" id="recordSubmit" type="submit"
                                    class="btn <?php echo $adv_arr['finish']['btn_class']; ?> btn-sm  rounded-0">
                                <i class="fa fa-paper-plane"></i> <?php echo $adv_arr['finish']['btn_text']; ?>
                            </button>
                        </div>
                    </div>
                    <input type="hidden" name="s_id_hidden" value="<?php echo $sale_id; ?>">
                    ...
                    <?php if ($sale_pays_id > 0) {
                        $rozQ = fetch('roznamchaas', array('r_type' => 'Business', 'transfered_from_id' => $sale_pays_id, 'transfered_from' => 'sale_advance'));
                ...
                if ($sale_pays_id > 0) { ?>
                    <form method="post"
                        ...
                        <button name="deletePaymentAndRozSubmit" type="submit" class="btn btn-danger btn-sm">Delete This
                            Payment
                        </button>
                    </form>
                <?php } ?>
        ...
        <div class="col-2 order-0 fixed-sidebar table-form">
            <div>
                ...
                <div class="bottom-buttons">
                    ...
                    <?php } ?>
                    <div class="px-2">
                        <a href="print/sales-invoice?s_id=<?php echo $sale_id; ?>&action=adv" target="_blank"

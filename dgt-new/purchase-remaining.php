<?php
$page_title = 'Purchase Rem';
$pageURL = 'purchase-remaining';
include("header.php");
...
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('purchase-remaining');
    $is_search = true;
    ...
    <div class="modal-dialog modal-fullscreen -modal-xl -modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">PURCHASE REMAINING</h5>
...
<script>
    function viewPurchase(id = null, purchase_pays_id = null) {
        if (id) {
            ...
            $.ajax({
                url: 'ajax/viewPurchaseRemaining.php',
                type: 'post',
                data: {
                    id: id,
                    level: 1,
...
if (isset($_POST['deleteRemPaymentAndRozSubmit'])) {
    ...
    $msg = 'DB Failed';
    $p_id_hidden = mysqli_real_escape_string($connect, $_POST['p_id_hidden']);
    $url_ = "purchase-remaining?view=1&p_id=" . $p_id_hidden;

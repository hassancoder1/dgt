<?php
$page_title = 'VAT SALES EXPORT';
$pageURL = 'vat-sale-export-invoice';
include("header.php");
...
$sql = "SELECT * FROM `transactions` WHERE p_s='s' AND vat='export'";
$conditions = [];
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('vat-sale-export-invoice');
    $is_search = true;

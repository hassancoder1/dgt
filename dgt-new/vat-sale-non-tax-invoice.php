...
$pageURL = 'vat-sale-non-tax-invoice';
include("header.php");
...
$sql = "SELECT * FROM `transactions` WHERE p_s='s' AND vat='non-tax'";
$conditions = [];
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('vat-sale-non-tax-invoice');
    $is_search = true;

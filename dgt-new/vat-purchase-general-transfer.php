<?php
$page_title = 'VAT PURCHASES GENERAL TRANSFER';
$pageURL = 'vat-purchase-general-transfer';
include("header.php");
...
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('vat-purchase-general-transfer');
    $is_search = true;
        ...
        if (id) {
            $.ajax({
                ...
                data: {
                    id: id,
                    level: 1,
                    page: "vat-purchase-general-transfer",
                    type: 'purchase'
                },

...
$sql = "SELECT * FROM `transactions` WHERE p_s='s' AND vat='tax'";
$conditions = [];
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('vat-sale-tax-invoice');
    $is_search = true;

...
$query = "SELECT COALESCE(MAX(sr), 0) + 1 AS next_sr FROM transactions WHERE p_s = 'p'";
...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $query = "SELECT COALESCE(MAX(sr), 0) + 1 AS next_sr FROM transaction_items WHERE p_s = 'p'";
    if (isset($_GET['id'])) {
        $myid = $_GET['id'];
    ...
    $NP_details = json_decode($record['notify_party_details'], true);
}
                    ...
                    <div class="d-flex gap-3 flex-wrap">
                        ...
                        <div class="flex-fill" style="max-width:24%;">
                            <div class="bg-light p-3 rounded">
                                ...
                                <!-- Submit Button -->
                                <button type="submit" name="purchaseSubmit" class="btn btn-dark btn-sm w-100 mt-3">Submit</button>
                            </div>
                        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        echo '<script>purchaseReports[\'goods_details\'] = "' . $prepareGoodsReport . '";</script>';
                        ?>
                    </tbody>
                </table>
            </div>
...
if ($id > 0): ?>
    <div class="card mb-3" style="border: none;">
        <div class="card-body">
            ...
            echo '<script>purchaseReports[\'loading_details\'] = "' . $prepareLoadingReport . '";';
            echo 'purchaseReports[\'payment_details\'] = "' . $preparePaymentReport . '";</script>';
            ?>
            <!-- <div class="row gx-3">
                        Sea/Road Details
    ...
    include("footer.php"); ?>
        ...
        <script type="text/javascript">
            ...
            function finalAmount() {
                ...
                if (!isNaN(weight) && weight !== 0 && !isNaN(net_kgs)) {
                    total = (net_kgs / weight).toFixed(2);
                }
                ...
                if (!isNaN(rate2) && rate2 !== 0 && !isNaN(amount)) {
                    final_amount = (operator === '/') ? (amount / rate2).toFixed(2) : (rate2 * amount).toFixed(2);
                }
        ...
        if (isset($_POST['notifyPartySubmit'])) {
            ...
            $done = update('transactions', ['notify_party_details' =>  mysqli_real_escape_string($connect, $notifyData)], array('id' => $hidden_id));
            if ($done) {
                $info['type'] = 'success';
                ...
                <form method="post">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex justify-content-end">
                            <input id="purchaseReportsSubmitBtn" name="purchaseReports" type="submit" value="Add Report" class="btn btn-dark" />
                        </div>
                    </div>
                </form>
            </div>
            ...
            if (isset($_POST['seaRoadDetailsSubmit'])) {
                ...
                if ($_POST['purchaseLocal'] == 'true') {
                    ...
                    foreach ($_POST as $key => $value) {
                        ...
                        if (!in_array($key, ['hidden_id', 'sea_road', 'lwl', 'purchaseLocal', 'seaRoadDetailsSubmit', 'route'])) {
                            unset($_POST[$key]);
                        }
                    }
                } else {
    ...
    <div class="modal-dialog modal-xl">
        ...
        <!-- Bootstrap Modal for Notify Party -->
        ...
        <script>
            ...
            function updateTaxAndTotal() {
                ...
                $('#tax_amount').val(taxAmount !== "0.00" ? taxAmount : '');
            ...
            function setupReports(reportType) {
                ...
                $('#reportBox').val(purchaseReports[reportType] || '');
                let BtnText = purchaseReports[reportType] ? 'Update Report' : 'Add Report';
                $('#purchaseReportsSubmitBtn').val(BtnText);

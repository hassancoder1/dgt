<?php
$page_title = 'VAT PURCHASES NON-TAX';
$pageURL = 'vat-purchase-non-tax-invoice';
include("header.php");
...
$sql = "SELECT * FROM `transactions` WHERE p_s='p' AND vat='non-tax'";
$conditions = [];
$print_filters = [];
if ($_GET) {
    $remove = removeFilter('vat-purchase-non-tax-invoice');
    $is_search = true;
        ...
        if (id) {
            $.ajax({
                ...
                data: {
                    id: id,
                    level: 1,
                    page: "vat-purchase-non-tax-invoice",
                    type: 'purchase'
                },

<?php $pageURL = 'purchase-market';
$page_title = 'PURCHASE MARKET';
include("header.php");
...
<?php if (isset($_POST['s_id_hidden_attach'])) {
    ...
    foreach ($_FILES["attachments"]["tmp_name"] as $key => $tmp_name) {
        if ($_FILES['attachments']['error'][$key] == 4 || ($_FILES['attachments']['size'][$key] == 0 && $_FILES['attachments']['error'][$key] == 0)) {
            ...
            $att = saveAttachment($ppp_id, 'purchase_market', basename($_FILES["attachments"]["name"][$key]));
...
<?php if (isset($_GET['view']) && $_GET['view'] == 1) {
    ...
    $topArray = array(
        array('heading' => 'PURCHASE DATE ', 'value' => '<input type="date" name="p_date" value="' . $p_date . '">'),
        ...
        <div class="modal-dialog modal-fullscreen -modal-xl -modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">MARKET PURCHASE</h5>
                                ...
                                <div class="d-flex justify-content-between flex-wrap gap-1 text-uppercase small">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <select class="form-select bg-transparent border-0" id="branch_id"
                                                    name="branch_id" style="min-width: 130px;">
                                    ...
                                    <?php $array_acc1 = array(array('label' => 'SELLER A/C#', 'id' => '_khaata_no'), array('label' => 'A/C NAME', 'id' => '_khaata_name'), array('label' => 'BRANCH', 'id' => '_b_name'),
                                    ...
                                    <div class="h6 font-size-12 text-uppercase">
                                        ...
                                        //$purchaser_khaata = khaataSingle($p_acc, true);
                                ...
                                <div class="row gx-1 mb-3 align-items-center">
                                    ...
                                    <div class="col-md">
                                        <div class="row" id="yes_account">
                                            <div class="col-md-4">
                                                <div class="input-group position-relative">
                                                    <label for="khaata_no">Dr. A/c [SELLER]</label>
                                        ...
                                        <div class="row gx-0" id="no_account">
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <label for="s_name">PUR. NAME</label>
                                    ...
                                    <div class="card-body p-2">
                                        <form method="post">
                                            <div class="row gx-1 gy-3 table-form mb-3">
                                                <div class="col-5">
                                                    <div class="input-group">
                                                        <label for="p_khaata_no" class="text-success">Dr.
                                                            (Sale)</label>
                                                        <input value="<?php echo $khaata_no; ?>" type="text"
                                                               id="p_khaata_no" name="dr_khaata_no" class="form-control"
                                                               readonly tabindex="-1">
                                                        <input type="hidden" name="dr_khaata_id"
                                                               value="<?php echo $khaata_id ?>">

                                                        <label for="s_khaata_no" class="text-danger">Cr. (Purchase)</label>
                                                        <input value="<?php echo $p_acc;//$record['s_khaata_no']; ?>"
                                                               id="s_khaata_no" name="cr_khaata_no" readonly
                                                               tabindex="-1" class="form-control" required>
                                                        <?php $dddddd = khaataSingle($p_acc, true); ?>
                                                        <input value="<?php echo $dddddd['id']; ?>" type="hidden"
                                                               name="cr_khaata_id">
                                                        <?php $vat_khaata_no = VAT_Account('khaata_no');
                                                        $vat_khaata_id = VAT_Account('khaata_id'); ?>
                                                        <label for="vat_khaata_no" class="text-danger">Cr. (VAT)</label>
                                                        <input value="<?php echo $vat_khaata_no; ?>" id="vat_khaata_no"
                                                               name="vat_khaata_no" readonly tabindex="-1"
                                                               class="form-control" required>
                                                        <input value="<?php echo $vat_khaata_id; ?>" type="hidden"
                                                               name="vat_khaata_id">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-2">
                                                    <div class="input-group">
                                                        <label for="vat_amount" class="mb-0">VAT Amount</label>
                                                        <input value="<?php echo round($vat, 2); ?>" id="vat_amount"
                                                               readonly name="vat_amount" class="form-control" required
                                                               tabindex="-1">
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                ...
                                                <div class="col-3">
                                                    <div class="input-group">
                                                        <label for="f_amount" class="mb-0">Final Amount</label>
                                                        <input value="<?php echo round($final_amount_total, 2); ?>"
                                                               id="f_amount" readonly name="amount" class="form-control"
                                                               required tabindex="-1">
                                                    </div>
                                                </div>
                                                <div class="col-11">
                                                ...
                                                <div class="col-auto">
                                                    <button name="ttrFirstSubmit" type="submit"
                                                            class="btn btn-primary w-100 btn-sm"><i
                                                            class="fa fa-upload"></i>Transfer
                                                    </button>
                                                </div>
                                                <input type="hidden" name="s_id_hidden" value="<?php echo $sale_id; ?>">
                                            </div>
                                            <?php if ($record['khaata_tr1'] != '') {
                                                $rozQ = fetch('roznamchaas', array('r_type' => 'Business', 'transfered_from_id' => $sale_id, 'transfered_from' => 'purchase_market'));
                        ...
                        <div class="col-2 order-1 fixed-sidebar table-form">
                            ...
                            <div class="bottom-buttons">
                                <div class="px-2">
                                    ...
                                    <?php $attachments = fetch('attachments', array('source_id' => $sale_id, 'source_name' => 'sale_market'));

...
$sql = "SELECT * FROM `sales` WHERE type = 'market' ORDER BY khaata_tr1 asc ";
                            ...
                            <tr class="pointer clickable-row <?php echo $rowColor; ?>"
                                ...
                                <td class="font-size-11 text-nowrap">
                                    <?php if (!empty($khaata_tr1)) {
                                        ...
                                        echo '<br><b>R. SR#</b> ';
                                        echo getTransferredToRoznamchaSerial('Business', $sale_id, 'sale_market');
                                    } ?>
                                </td>
                            </tr>
                            <?php $row_count++;
        ...
        <div class="modal-dialog modal-fullscreen -modal-xl -modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">MARKET SALE [FINAL]</h5>
                            ...
                            <form method="post" class="table-form">
                                <div class="d-flex justify-content-between flex-wrap gap-1 text-uppercase small">
                                    ...
                                    <div class="h6 font-size-12 text-uppercase">
                                        ...
                                        <input type="hidden" id="purchase_account" name="p_acc" value="<?php echo $p_acc; ?>">
                                    </div>
                                </div>
                                <hr class="mt-0">
                                    ...
                                    <div class="card-body p-2">
                                        <form method="post">
                                            <div class="row gx-1 gy-3 table-form mb-3">
                                                <div class="col-5">
                                                    <div class="input-group">
                                                        <label for="p_khaata_no" class="text-danger">Cr.
                                                            (Purchaser)</label>
                                                        <input value="<?php echo $khaata_no; ?>" type="text"
                                                               id="p_khaata_no" name="cr_khaata_no" class="form-control"
                                                               readonly tabindex="-1">
                                                        ...
                                                        <input value="<?php echo $p_acc;//$record['s_khaata_no']; ?>"
                                                               id="s_khaata_no" name="dr_khaata_no" readonly
                                                        ...
                                                        $vat_khaata_id = VAT_Account('khaata_id'); ?>
                                                        <label for="vat_khaata_no" class="text-success">Dr.
                                                            (VAT)</label>
                                            ...
                                            <?php if ($record['khaata_tr1'] != '') {
                                                $rozQ = fetch('roznamchaas', array('r_type' => 'Business', 'transfered_from_id' => $sale_id, 'transfered_from' => 'sale_market'));

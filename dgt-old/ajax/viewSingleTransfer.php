...
if ($id > 0) {
    ...
    <div class="row">
        ...
        <div class="col-md-2 order-0 fixed-sidebar table-form shadow">
            <?php
            if ($source == 'purchase') {
                $btns_array = array(array('title' => 'Transfer Warehouse', 'type' => 'TWarehouse', 'd_id' => $d_id));
            ...
            $show_agent_stock_form = false;
            if ($source == 'purchase') {
                if (!empty($tware_json)) {
                    $show_agent_stock_form = true;
                }
            } else {
                $show_agent_stock_form = true;
            }
            if ($show_agent_stock_form) { ?>

                <h6 class="text-center">Transfer to Agent/Stock form</h6>
                <form method="post" class="d-flex">
                    ...
                    <input value="<?php echo $source; ?>" type="hidden" name="source_hidden">

            ...
            <div class="card">
                <div class="card-body p-2 text-uppercase- small">
                    ...
                    <div class="row mb-1">
                        ...
                        $check_agent_query = fetch('purchase_agents', array('d_id' => $d_id, 'khaata_id' => $khaataId, 'type' => $agent_data['type']));
                        if (mysqli_num_rows($check_agent_query) > 0) {
                            ...
                            if (!empty($details)) {
                                ...
                                /*echo '<b>Container Return</b>' . $details->ctr_return_date;
                                ...
                                //echo '<b>Driver Name</b>' . $details->driver_name;
                                //echo '<br><b>Phone</b>' . $details->driver_phone;
                                echo '</div>';
                                $bail_array = array(
                                    ...
                                    /*'ctr_return_date' => $details->ctr_return_date,
                                    'truck_no' => $details->truck_no,
                                    'ctr_name' => $details->ctr_name,
                                    'ctr_no' => $details->ctr_no,
                ...
                <div class="row table-form gx-1 gy-3">
                    ...
                    <!--<div class="col-md-3">
                        <div class="input-group">
                            ...
                            <input value="<?php /*echo $bail_array['ctr_return_date']; */ ?>" type="date" id="ctr_return_date" name="ctr_return_date" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <label for="truck_no">Loading Truck#</label>
                            <input value="<?php /*echo $bail_array['truck_no']; */ ?>" type="text" id="truck_no" name="truck_no" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <label for="ctr_name">Container Name</label>
                            <input value="<?php /*echo $bail_array['ctr_name']; */ ?>" type="text" id="ctr_name" name="ctr_name" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <label for="ctr_no">Container#</label>
                            <input value="<?php /*echo $bail_array['ctr_no']; */ ?>" type="text" id="ctr_no" name="ctr_no" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <label for="driver_name">Driver Name</label>
                            <input value="<?php /*echo $bail_array['driver_name']; */ ?>" type="text" id="driver_name" name="driver_name" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="input-group">
                            <label for="driver_phone">Driver Phone</label>
                            <input value="<?php /*echo $bail_array['driver_phone']; */ ?>" type="text" id="driver_phone" name="driver_phone" class="form-control">
                        </div>
                    </div>-->
                </div>
                <div class="mt-2">

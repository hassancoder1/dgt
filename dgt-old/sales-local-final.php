<?php $pageURL = 'sales-local-final';
$sql = "SELECT * FROM `sales` WHERE type = 'local' ORDER BY khaata_tr1 ";
$page_title = 'LOCAL SALES [FINAL]';
include("header.php");
global $branchId;
                ...
                <div class="table-responsive" style="height: 76dvh;">
                    <table class="table mb-0 table-bordered table-sm fix-head-table">
                        ...
                        while ($sale = mysqli_fetch_assoc($sales)) {
                            ...
                            <tr class="pointer clickable-row <?php echo $rowColor; ?>" data-href="<?php echo $pageURL . '?view=1&id=' . $sale_id; ?>">
                                ...
                                <td class="font-size-10">
                                    <?php echo readMoreTooltip($sale['report'], 80) ?>
                                </td>
                                <td class="font-size-11 text-nowrap">
                                ...
                                <td class="font-size-11 text-nowrap">
                                    <?php if (!empty($khaata_tr1)) {
                                        ...
                                        echo '<br><b>R. SR#</b> ';
                                        echo getTransferredToRoznamchaSerial('Business', $sale_id, 'sale_local');
                                    } ?>
                                </td>
                            </tr>
                            <?php $row_count++;
...
<?php if (isset($_GET['view']) && $_GET['view'] == 1) {
    ...
    $is_acc_no = $khaata_no = $p_acc = $s_name = $receiver = $size = $brand = $is_qty = $type = $city = $qty_name = $divide = $price = $currency2 = $report = '';
        ...
        <div class="modal-dialog modal-fullscreen -modal-xl -modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">LOCAL SALE [FINAL]</h5>
                                ...
                                <div class="row gx-1 mb-3 align-items-center">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <div class="row gx-0" id="no_account">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">
                                                    <label for="s_weight_no">WEIGHT #</label>
                                ...
                                <?php if ($action_hidden != 'update') { ?>
                                    <div class="row gx-1 gy-3">
                                        ...
                                        <div class="row gx-1 gy-1">
                                            ...
                                            <div class="col-3 toggleQty">
                                                <div class="input-group">
                                                    <label for="final_amount" class="text-danger">FINAL AMOUNT</label>
                                    ...
                                    <div class="card-body p-2">
                                        <form method="post">
                                            <div class="row gx-1 gy-3 table-form mb-3">
                                                ...
                                                <div class="col-3">
                                                    <div class="input-group">
                                                        <label for="f_amount" class="mb-0">Amount</label>
                                            ...
                                            <?php if ($record['khaata_tr1'] != '') {
                                                $rozQ = fetch('roznamchaas', array('r_type' => 'Business', 'transfered_from_id' => $sale_id, 'transfered_from' => 'sale_local'));
                        ...
                        <div class="col-2 order-1 fixed-sidebar table-form">
                            ...
                            <div class="bottom-buttons">
                                <div class="px-2">
                                    ...
                                    <a href="print/sales-market?s_id=<?php echo $sale_id; ?>&action=local"
                                       target="_blank"

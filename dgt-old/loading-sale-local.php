<?php $pageURL = 'loading-sale-local';
$page_title = 'Sales Local Loading Form ';
include("header.php");
...
$sql2 = "SELECT * FROM sale_details ORDER BY is_transfer";
                                    ...
                                    <tr class="text-uppercase <?php echo $rowColor; ?>">
                                        ...
                                        <td class="font-size-10">
                                            <?php if ($source_table == 'purchase') {
                                                ...
                                                echo '<div style="width: 150px" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="' . $parent_data['report'] . '">' . readMore($parent_data['report'], '80') . '</div>';
                                            } ?>
                                        </td>
                                        <td class="font-size-10 text-nowrap">

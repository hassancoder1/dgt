...
<div class="row">
    <div class="col-lg-12 ">
        <div class="d-flex justify-content-between gap-md-4">
            ...
            <form action="print/sale-account" method="post" id="printLedgerForm" target="_blank" class="">
        ...
        <div class="d-flex justify-content-between align-items-start gap-md-3 text-uppercase small">
            <div class="flex-fill card p-1 mb-1">
                ...
                <!--<div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>Qty <span id="total_qty_span" class="fw-bold"></span></div>
                </div>-->
                <!--<div class="d-flex justify-content-between">
                    <div>KGs <span id="total_kgs_span" class="fw-bold"></span></div>
                    <div>Amount <span id="total_amount_span" class="fw-bold"></span></div>
                </div>
                <div class="d-flex justify-content-between">
                    <div>Net KGs <span id="net_kgs_span" class="fw-bold"></span></div>
                    <div>F.Amount <span id="total_final_amount_span" class="fw-bold"></span></div>
                </div>-->
            </div>
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success === true) {
                    ...
                    //alert(khaata_id);
                    $.ajax({
                        url: 'ajax/fetchSalesAccountWise.php',
                        type: 'post',

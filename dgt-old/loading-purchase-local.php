<?php $pageURL = 'loading-purchase-local';
$page_title = 'Purchases Local Loading ';
include("header.php");
                                    ...
                                    <tr class="text-uppercase <?php echo $rowColor; ?>">
                                        ...
                                        <td class="font-size-10">
                                            <?php if (!empty($ware_json)) {
                                                $ware_khaata = khaataSingle($ware_json->party_khaata_id);
                                                echo '<b>A/C</b>' . $ware_khaata['khaata_no'];
                                                echo '<b>WH.NAME</b>' . $ware_json->comp_name . '<br><b>COUNTRY</b>' . $ware_json->country . '<br><b>CITY</b>' . $ware_json->city;
                                            } ?>
                                        </td>
                                        <td class="font-size-10">
                                            <?php if (!empty($tware_json)) {
                                                $tware_khaata = khaataSingle($tware_json->party_khaata_id);
                                                echo '<b>A/C</b>' . $tware_khaata['khaata_no'];
                                                echo '<b>WH.NAME</b>' . $tware_json->comp_name . '<br><b>COUNTRY</b>' . $tware_json->country . '<br><b>CITY</b>' . $tware_json->city;
                                            } ?>
                                        </td>
                                    </tr>
                                    <?php ++$row_count;

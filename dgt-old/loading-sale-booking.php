<?php $pageURL = 'loading-sale-booking';
$page_title = 'Sales Booking Loading Form ';
include("header.php");
                                ...
                                if ($purchase_sale_type == 'booking') {
                                    ...
                                    <tr class="text-uppercase <?php echo $rowColor; ?>">
                                        ...
                                        <td class="font-size-10">
                                            <?php echo '<div style="width: 150px" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="' . $parent_data['report'] . '">' . readMore($parent_data['report'], '80') . '</div>'; ?>
                                        </td>
                                        <td class="font-size-10 text-nowrap">

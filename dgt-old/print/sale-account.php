...
if (isset($_POST['khaata_id']) && ($_POST['khaata_id'] > 0) && isset($_POST['secret']) && isset($_POST['goods_id'])
    ...
    if (base64_decode($_POST['secret']) == "powered-by-upsol") {
        ...
        <head>
            <meta charset="UTF-8">
            <title>Sale_account_<?php echo date('Y_m_d'); ?></title>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center ">
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <div class="text-end">
                            <h1 class="fw-bold mb-0 text-uppercase">Sale Account</h1>
            ...
            <div class="row justify-content-center  ">
                <div class="col-12">
                    <div class="d-flex justify-content-between border border-bottom-0 border-dark small px-1 text-uppercase">
                    ...
                    <table class="table mb-0 table-bordered table-sm ">
                        ...
                        <tbody>
                        <?php $sale_details_query = fetch('sale_details');
                        while ($details = mysqli_fetch_assoc($sale_details_query)) {
                            ...
                            if ($s_khaata_id == $khaata_id) {
                                ...
                                echo '<td>' . $parent_id . '-' . $details['d_sr'] . saleSpecificData($parent_id, 'sale_type') . '</td>';
                                echo '<td>' . $details['allot_name'] . '</td>';
                                echo '<td>NILL</td>';
                                echo '<td>' . my_date($sale['s_date']) . '</td>';
                                echo '<td>' . $imp_name . '</td>';

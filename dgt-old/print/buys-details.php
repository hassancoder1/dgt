...
if (isset($_GET['buys_id']) && ($_GET['buys_id'] > 0) && isset($_GET['bd_id']) && ($_GET['bd_id'] > 0) && isset($_GET['secret'])) {
    if (base64_decode($_GET['secret']) == "powered-by-upsol") {
        ...
        if ($buys_details['jmaa_khaata_id'] == 0) {
            message('danger', '../buys-add?id=' . $buys_id . '&bd_id=' . $buys_details_id . '&action=update', 'یہ بل ابھی ٹرانسفر نہیں ہوا ہے۔ پرنٹ سے پہلے ٹرانسفر کرنا ضروری ہے۔');
        }
                                ...
                                <div class="border container border-dark pb-4">
                                    <div class="row justify-content--center row-cols-4 gy-3 gx-0">
                                        <?php $buyArray = array(
                                            ...
                                            array('col_name' => 'بل نمبر', 'col_val' => $buys_details['bill_no'], 'class' => 'col-2', 'span_id' => '', 'span_class' => '', 'span_attr' => ''),
                                            array('col_name' => 'کنٹینر نمبر', 'col_val' => $buys_details['container_no'], 'class' => 'col-3', 'span_id' => '', 'span_class' => '', 'span_attr' => ''),
                                            array('col_name' => 'لاٹ نام', 'col_val' => $buys_details['allot_name'], 'class' => 'col-3', 'span_id' => '', 'span_class' => '', 'span_attr' => ''),
                                            array('col_name' => 'تاریخ', 'col_val' => $buys_details['bd_date'], 'class' => 'col-4', 'span_id' => '', 'span_class' => '', 'span_attr' => ''),
                                            ...
                                            array('col_name' => 'کھاتہ', 'col_val' => $jmaa['khaata_name'], 'class' => 'col-5', 'span_id' => '', 'span_class' => '', 'span_attr' => ''),
                                            array('col_name' => 'فون', 'col_val' => $jmaa['mobile'] . ' | ' . $jmaa['whatsapp'], 'class' => 'col-5', 'span_id' => '', 'span_class' => '', 'span_attr' => 'dir="ltr"'),
                                            //array('col_name' => '', 'col_val' => $jmaa['whatsapp'], 'class' => 'col-3', 'span_id' => '', 'span_class' => '', 'span_attr' => 'dir="ltr"'),
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr style="line-height: 3;">
                                            ...
                                            <td><?php echo $buys_details['marka']; ?></td>
                                            ...
                                            <td>
                                                ...
                                                <?php echo ' ٹوٹل خالی وزن ' . round($buys_details['total_empty_wt']); ?>
                                                <?php echo ' صافی وزن ' . round($buys_details['saaf_wt']); ?>
                                                <?php echo ' فی تقسیم ' . $buys_details['taqseem_name'] . round($buys_details['taqseem_no']); ?>
                                    ...
                                    <div class="row gy-3">
                                        <div class="col-8 mb-0 mb-md-2">
                                            <p class="urdu small ">
                                                ...
                                                <span class="small ms-1"><?php echo AmountInWordsUrdu($buys_details['qeemat_raqam']); ?></span>
                                            </p>
                                        </div>
                                        <div class="col-4 mb-0 mb-md-2">
                                            <p class="urdu small float-end">
                                                <span class="bold">ٹوٹل: </span>
                                                <span class="small ms-1"><?php echo $buys_details['qeemat_raqam']; ?></span>
                                            </p>
                                        </div>
                                        <div class="col-12 mb-0 mb-md-2">
                                            <p class="urdu small">
                                                <span class="bold">مزید تفصیل: </span>
                                                <span class="small ms-1"><?php echo $buys_details['more_details']; ?></span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row mt-2 gy-3">
                                        <div class="col-4">
                                            <p class="urdu">
                                                ...
                                                <span class="ms-1"><?php echo $buys_details['payment_date']; ?></span>
                                            </p>
                                        </div>
                                        <div class="col-2"></div>
                                        <div class="col-6">
                                            <p class="urdu float-end">
                                                <span class="bold">دستخط: </span>
                                                <span class="ms-1">_______________________________________</span>
                                            </p>

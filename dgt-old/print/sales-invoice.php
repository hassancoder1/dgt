<?php if (isset($_GET['s_id']) && $_GET['s_id'] > 0 && isset($_GET['action'])) {
    ...
    <head>
        <meta charset="UTF-8">
        <title>Sale_<?php echo $sale_id . '__' . date('Y_m_d'); ?></title>
        ...
        <div class="container-fluid" style="page-break-before: always;">
            <div class="row justify-content-center fixed-top-bg-white">
                <div class="col-lg-7 col-12">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-end">
                            <h1 class="fw-bold mb-0"><?php echo strtoupper($s_data['type'] . ' SALE'); ?></h1>
                            <b>DATE</b>
                            <?php //echo date('F d,Y', strtotime($s_data['s_date']));
                            echo my_date($s_data['s_date']);
                            //echo '<br><b>TYPE </b> ' . $s_data['type'];
            ...
            <div class="row justify-content-center g-0">
                <div class="col-lg-7 col-12">
                    ...
                    <h6>
                        <?php echo '<b>A/C. </b> ' . strtoupper($seller_khaata_no) . '<br>';
            ...
            <div class="container-fluid">
                <div class="row justify-content-center g-0">
                    <div class="col-lg-7 col-12">
                        ...
                        <img src="pdf-footer.png" class="img-fluid" alt="bottom pic">
                    </div>
                </div>
            </div>
        </div>

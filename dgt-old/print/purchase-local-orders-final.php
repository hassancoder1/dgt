<?php if (isset($_GET['start']) && isset($_GET['end']) && isset($_GET['goods_name']) && isset($_GET['size']) && isset($_GET['brand']) && isset($_GET['origin']) && isset($_GET['is_transferred']) && isset($_GET['s_khaata_id'])
    ...
    $backURL = '../purchase-local-orders-final';
    require("../connection.php");
    global $connect;
    $sql = "SELECT * FROM `purchases` WHERE type = 'local' AND is_locked =1";
    ...
    <head>
        <meta charset="UTF-8">
        <title>Purchase_Orders_Local_Final_<?php echo date('Y_m_d'); ?></title>
        ...
        <div class="row justify-content-center ">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between mb-1">
                    ...
                    <div class="text-end">
                        <h2 class="fw-bold mb-0 text-uppercase">Purchase Orders [LOCAL FINAL]</h2>

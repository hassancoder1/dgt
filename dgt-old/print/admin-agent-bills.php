<?php if (isset($_GET['agent_khaata_id']) && isset($_GET['start']) && isset($_GET['end']) && isset($_GET['imp_exp'])
    && isset($_GET['is_complete']) && isset($_GET['is_transferred'])) {
    ...
    <head>
        <meta charset="UTF-8">
        <title>Agent_Bills_<?php echo date('Y_m_d'); ?></title>
        ...
        <div class="row justify-content-center ">
            <div class="col-md-10- col-12">
                <div class="d-flex align-items-center justify-content-between mb-1">
                    ...
                    <div class="text-end">
                        <h1 class="fw-bold mb-0 text-uppercase">Agent Bills</h1>
                            ...
                            <td class="font-size-11 text-nowrap">
                                <?php if (!empty($bill)) {
                                    if (isset($bill->p_id_hidden)) {
                                        ...
                                        $purch_temp = fetchTableAssoc($bill->p_id_hidden, 'purchases');

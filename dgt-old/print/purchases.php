<?php if (isset($_GET['start']) && isset($_GET['end']) && isset($_GET['goods_name']) && isset($_GET['ps_type'])
    && isset($_GET['adv_full']) && isset($_GET['is_transferred']) && isset($_GET['s_khaata_id'])
) {
    $backURL = '../purchases';
    ...
    <head>
        <meta charset="UTF-8">
        <title>Bill_Transfer_Form_<?php echo date('Y_m_d'); ?></title>
        ...
        <div class="row justify-content-center ">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between mb-1">
                    ...
                    <div class="text-end">
                        <h2 class="fw-bold mb-0 text-uppercase">Bill Transfer Form</h2>

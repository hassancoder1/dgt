...
if (isset($_GET['r_id']) && !(empty($_GET['r_id'])) && isset($_GET['secret'])) {
    if (base64_decode($_GET['secret']) == "powered-by-upsol") {
        ...
        <head>
            ...
            <title>Roznamcha Cash Flow_<?php echo $khaata_id . '_' . date('Y_m_d-H_i_s'); ?></title>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-12">
                    <div class="d-flex align-items-center justify-content-between">
                        <div><img src="../assets/images/logo.png" alt="logo" class="img-fluid"
                                  style="width: 80px;"></div>
                        <div><h2 class="fw-bold text-nowrap">ROZNAMCHA CASH FLOW</h2></div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <h5 class="fw-bold">DAMAAN GENERAL TRADING L.L.C</h5>
                        </div>
                        <div>
                            <h6 class="fw-bold bg-dark text-white p-2">OFFICE COPY</h6>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="row mt-1 gx-1">
                        <div class="col">
                            <div class="border px-1 border-dark">

...
if (isset($_GET['buys_id']) && ($_GET['buys_id'] > 0) && isset($_GET['secret'])) {
    if (base64_decode($_GET['secret']) == "powered-by-upsol") {
        ...
        $backUrl = '../buys-add?id=' . $buys_id;
        $copies = array(
            array(
                'name' => 'فروخت کنندہ کاپی',
                'bg_color' => 'bg-light',
            ),
            array(
                'name' => 'کمپنی کاپی',
        ...
        <head>
            ...
            <title>خریداری فارم_<?php echo $record['id'] . '_' . $record['bail_no'] . '_' . date('Y_m_d-H_i_s'); ?>
            </title>
                ...
                <div class="row justify-content-center fixed-top-bg-white ">
                    <div class="col-lg-7 col-12">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="urdu">
                                <h1 class="fw-bold mb-0 ">خریداری رسید</h1>
                            </div>
                            <div class="urdu">
                ...
                <div class="row justify-content-center g-0">
                    <div class="col-lg-7 col-12 urdu">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-5">
                            <div>
                                ...
                                if (!empty($record['dr_khaata_json'])) {
                                    ...
                                    $bnaam_query = fetch('khaata', array('id' => $dr_khaata_json->bnaam_khaata_id));
                                    $bnaam = mysqli_fetch_assoc($bnaam_query);
                                    echo '<div class="mb-2"><b>اکاؤنٹ: </b> ' . strtoupper($dr_khaata_json->bnaam_khaata_no) . '</div>';
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            $sales = mysqli_query($connect, "SELECT * FROM `buys_details` WHERE buys_id = $buys_id ORDER BY qeemat_raqam ASC ");
                            ...
                            <?php if (!empty($record['dr_khaata_json'])) {
                                $jj = json_decode($record['dr_khaata_json']);
                                //var_dump($jj);
                            ...
                            $roz_info = [];
                            if ($dr_khaata_json != '') {
                                $rozQ = fetch('roznamchaas', array('r_type' => 'karobar', 'transfered_from_id' => $buys_id, 'transfered_from' => 'buys_details'));

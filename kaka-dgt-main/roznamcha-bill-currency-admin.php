...
if ($_POST) {
    $removeFilter = removeFilter('roznamcha-bill-currency-admin');
...
<div class="heading-div d-flex justify-content-between align-items-center flex-wrap grid-margin px-2 py-1 border-bottom">
    <div>
        <h4 class="mb-3 mb-md-0">ایڈمن بلہ چمک</h4>
    </div>
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        ...
        <a href="roznamcha-bill-admin" class="btn btn-dark btn-icon-text py-1 me-1">
            <i class="btn-icon-prepend" data-feather="arrow-left-circle"></i>بل روزنامچہ</a>
        <form action="print/roznamcha-full" method="post" target="_blank">
            ...
            <input name="r_sub_type" value="<?php echo BILL_CURRENCY; ?>" type="hidden">
            ...
            <input name="url" value="roznamcha-bill-currency-admin" type="hidden">
        ...
        <div class="col-md-6">
            <div class="row gy-0">
                ...
                <div class="col">
                    <div class="input-group mb-2 mb-md-0">
                        <span class="input-group-text input-group-addon bg-transparent urdu">میزان</span>
                        <input type="text" class="form-control bg-transparent border-primary ltr"
                               placeholder="میزان"
                    ...
                    if (mysqli_num_rows($records) > 0) {
                        while ($roz = mysqli_fetch_assoc($records)) { ?>
                            <tr>
                                ...
                                <td class="small"><?php echo getTableDataByIdAndColName('branches', $roz['branch_id'], 'b_name'); ?></td>
                                ...
                                <?php $jmaa += $roz['jmaa_amount'];
                                $bnaam += $roz['bnaam_amount'];
                                $jmaaBnaamString = $bnaam == 0 ? "جمع" : "بنام"; ?>
                                <td class="small-2">
                                    <span><?php echo $jmaaBnaamString; ?>:- </span>
                                    <span>فی قیمت:<?php echo $roz['per_price']; ?> </span>
                                    <span>جمع تعداد:<?php echo $roz['jmaa_qty']; ?> </span>
                                    <span>بنام تعداد:<?php echo $roz['bnaam_qty']; ?> </span>
                        ...
                        echo '<tr class="text-center"><th colspan="11"> کوئی ریکارڈ موجود نہیں ہے۔</th></tr>';
                    } ?>
                    </tbody>
                </table>
            </div>

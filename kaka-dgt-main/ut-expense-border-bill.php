...
$sql = "SELECT * FROM ut_bail_entries WHERE is_surrender = 1 AND border_user_ids IS NOT NULL ";
if ($_POST) {
    $removeFilter = removeFilter('ut-expense-border-bill');
...
<div class="heading-div d-flex justify-content-between align-items-center flex-wrap grid-margin px-4 py-1 border-bottom">
    <div><h4 class="mb-3 mb-md-0"> بارڈر خرچہ بل </h4></div>
            ...
            <div class="table-responsive scroll screen-ht">
                <table class="table table-bordered table-striped_ table-hover" id="fix-head-table">
                    ...
                    <?php while ($loading = mysqli_fetch_assoc($records)) {
                        ...
                        if (!empty($loading['khaata_border'])) { //condition: k kharcha daal dia h.
                            ...
                            <tr class="text-nowrap <?php echo $rowClass; ?>">
                                <td class="small-2">
                                    ...
                                    <a class="btn btn-primary pt-0 p-1 mt-n1 btn-sm float-end" data-tooltip="بل کا پرنٹ"
                                       ...
                                       href="print/ut-expense-bill?bail_id=<?php echo $loading["id"]; ?>&secret=<?php echo base64_encode("powered-by-upsol") ?>&start_date=<?php echo $print_start_date; ?>&end_date=<?php echo $print_end_date; ?>&type=<?php echo BORDER; ?>&url=<?php echo base64_encode('ut-expense-border-bill') ?>"><i class="fa fa-print"></i>
                                    </a>
                                ...
                                <td class="small-2">
                                    <?php $khaata_ = json_decode($loading['khaata_' . BORDER]);
                                ...
                                <td class="border border-light text-danger text-nowrap">
                                    <?php //$khaata_ = json_decode($loading['khaata_border']);
                                    echo 'ٹوٹل بل: ';

...
if (isset($_GET['id']) && !empty($_GET['id']) && is_numeric($_GET['id']) && isset($_GET['type'])
    ...
    $urlArray = array('godam-received' => array('path' => 'dt-kiraya-godam-received', 'title' => ' گودام پہنچ انٹری ', 'type' => 'کرایہ سمری', 'transfered_from' => 'godam_received'));
                    ...
                    <div class="card mt-2 border-top-0">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <?php $maal2Id = $taqseem_qty = $per_mazdoori = $total_exp = $remainingRows = $godam_receive_no =
                                $receive_bardana_qty = $bardana_balance = $bardana_qty = $per_wt = $total_wt = $empty_wt = $total_empty_wt =
                                $saaf_wt = $total_expFinal = 0;
                                $x = 1;
                                ...
                                while ($maal = mysqli_fetch_assoc($maals)) {
                                    ...
                                    <tr class="row-py-0 cursor-pointer" id="<?php echo $maal['id']; ?>" data-maal2-id="<?php echo $maal2Id; ?>" data-form-name="<?php echo $page['transfered_from']; ?>" onclick="maalEntryRowEdit(this)">
                                        <td><?php echo $x; ?></td>

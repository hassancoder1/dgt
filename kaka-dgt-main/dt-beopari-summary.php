...
<div
    ...
    <div>
        <h4 class="mb-3 mb-md-0 mt-n2">ڈاؤن ٹرانزٹ بیوپاری سمری</h4>
    </div>
    ...
    <form name="datesSubmit" method="get" class="d-flex">
        ...
        <div class="flatpickr wd-80" id="flatpickr-date">
            <input id="r_date_end" name="r_date_end" value="<?php echo $end_date; ?>" type="text" class="form-control" placeholder="تاریخ انتہاء" data-input>
        </div>
        <div class="input-group wd-200">
            ...
            <input type="text" id="bnaam_khaata_no" name="bnaam_khaata_no"
                   class="form-control urdu" placeholder="بنام اکاؤنٹ نمبر" value="<?php echo $searchBnaamKhaataNo; ?>"
                   required>
        </div>
    </form>
</div>
                ...
                <table class="table table-bordered table-sm table-hover" id="fix-head-table">
                    ...
                    while ($loading = mysqli_fetch_assoc($records)) {
                        ...
                        if (empty($loading['khaata_bs'])) {
                            $isMaal2Added = fetch('dt_truck_maals2', array('dt_tl_id' => $loading["id"], 'form_name' => 'beopari_summary_dt'));
                            $count_maal2 = 0;
                            ...
                            continue; // show in final, if khaata_bs is filled
                        }
                        if (empty($loading['khaata_bs'])) {
                            if ($isKhaataPosted) {
                                continue;
                        ...
                        <tr class="<?php echo $rowColor; ?> text-nowrap">
                            <td><?php echo $loading["id"]; ?>
                                <a href="dt-summary-transfer?id=<?php echo $loading['id']; ?>&type=beopari-summary"
                            ...
                            <td class="small-3"><?php echo $names['dt_comp_name']; ?><br><span
                                    dir="ltr"><?php echo $names['dt_sender_mobile']; ?></span></td>
                            <td class="small-3"><?php echo $names['dt_comp_name_r']; ?><br><span
                                    dir="ltr"><?php echo $names['dt_receiver_mobile']; ?></span></td>
                            ...
                            $ddd = fetch('dt_truck_maals2', array('dt_tl_id' => $loading['id'], 'form_name' => 'beopari_summary_dt'));

...
<?php if (is_clearance_roznamcha_allowed('chaman', $userId)) {
...
$sql = "SELECT * FROM roznamchaas WHERE r_type= 'ut_chaman' AND r_date = '$searchDate'";
//echo $sql;
...
<div class="heading-div d-flex justify-content-between align-items-center flex-wrap grid-margin px-4 py-1 border-bottom">
    <div>
        <h4 class="mt-n2 mb-3 mb-md-0">روزنامچہ چمن</h4>
    </div>

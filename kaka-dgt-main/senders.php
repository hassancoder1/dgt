<?php include("header.php"); ?>
    <div
        ...
        <div>
            <h4 class="mb-3 mb-md-0">مال بھیجنے والا تفصیل</h4>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="table-responsive scroll screen-ht">
                    <table class="table table-sm- table-bordered " id="fix-head-table">
                        <thead>
                        ...
                        <tbody>
                        <?php $records = fetch('senders');
                        while ($record = mysqli_fetch_assoc($records)) { ?>
                            <tr class="text-nowrap">
                                <td class="small urdu-td">
                                    <a href="sender-add?id=<?php echo $record['id']; ?>">
                                ...
                                <!--<td>
                                        <a onclick="deleteRecord(this)" data-url="dt-senders"
                                           data-tbl="dt_senders" id="<?php /*echo $record['id']; */ ?>">

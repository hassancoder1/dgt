            ...
            <div class="card mt-2">
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row gx-0 gy-4">
                            <div class="col-lg-2">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="khaata_no" name="khaata_no" class="form-control" required
                                           autofocus value="<?php echo $record['khaata_no']; ?>">
                                    <span id="response" class="text-danger urdu khaata-invalid"></span>
                                </div>
                                <input type="hidden" name="khaata_id" id="khaata_id" value="<?php echo $khaata_id; ?>">
                            </div>
                            <div class="col-lg-2">
                        ...
                        <a href="roznamcha-karobar-add.php"
                        ...
                        <?php if ($record['jmaa_amount'] > 0) { ?>
                            <a href="print/roznamcha-karobar.php?r_id=<?php echo base64_encode($id); ?>&print=<?php echo random_str('10'); ?>&secret=<?php echo base64_encode('powered-by-upsol'); ?>"
                               target="_blank"
...
if (isset($_POST['recordUpdate'])) {
    ...
    $url = "roznamcha-karobar-add.php?id=" . $hidden_id;
    $bnaam_amount = mysqli_real_escape_string($connect, $_POST['bnaam_amount']);
    $jmaa_amount = mysqli_real_escape_string($connect, $_POST['jmaa_amount']);
    //$cat_id = getTableDataByIdAndColName('khaata', $_POST['khaata_id'], 'cat_id');
    $k_data = fetch('khaata', array('id' => $_POST['khaata_id']));

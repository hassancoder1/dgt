<?php include("header.php"); ?>
    <div class="heading-div d-flex justify-content-between align-items-center flex-wrap grid-margin px-4 py-1 border-bottom">
        <div>
            <h4 class="mb-3 mb-md-0">آل امپورٹر تفصیل</h4>
        </div>
                ...
                <div class="">
                    <div class="table-responsive scroll screen-ht">
                        <table class="table table-bordered " id="fix-head-table">
                            ...
                            <tbody>
                            <?php $records = fetch('importers');
                            while ($record = mysqli_fetch_assoc($records)) { ?>
                                <tr class="text-nowrap">
                                    <td class="small urdu-td">
                                        <a href="importer-add?id=<?php echo $record['id']; ?>">
                                    ...
                                    <td class="urdu-td"><?php echo $record['comp_mobile']; ?></td>
                                    <td><?php echo $record['comp_email']; ?></td>
                                    <td class="small urdu-td"><?php echo $record['comp_city']; ?></td>
                                    <td class="small urdu-td"><?php echo $record['comp_address']; ?></td>
                                    <td><?php echo $record['comp_ntn']; ?></td>
                                    <td><?php echo $record['comp_tax_no']; ?></td>
                                    <td class="small urdu-td"><?php echo $record['kansani_name']; ?></td>
                                    <td class="small urdu-td"><?php echo $record['rebock_id']; ?></td>

...
$pageURL = 'dt-maal-entry';
$searchUserName = $date_append = $username_msg = $date_msg = $removeFilter = "";
$start_date = $end_date = date('Y-m-d');
$sql = "SELECT * FROM dt_truck_loadings WHERE is_transfered = 1 AND is_docs=1 ";
if ($_GET) {
...
<div
    ...
    <div>
        <h4 class="mt-n2 mb-3 mb-md-0">ڈاؤن ٹرانزٹ مال انٹری</h4>
    </div>
    ...
    <form name="datesSubmit" method="get" class="d-flex">
        ...
        <div class="input-group wd-150 ms-3">
            <label for="username" class="input-group-text urdu">ٹرک
                نمبر</label>
            <input type="text" id="username" name="username" class="form-control" placeholder="ٹرک نمبر"
            ...
            <div class="table-responsive scroll screen-ht">
                <table class="table table-bordered table-sm table-hover" id="fix-head-table">
                    ...
                    <tr class="text-nowrap ">
                        ...
                        <th>ڈرائیورنام</th>
                        <th class="small-2">سیریل<br> تعداد</th>
                    ...
                    while ($loading = mysqli_fetch_assoc($records)) {
                        ...
                        $tadadQuery = fetch('dt_truck_maals', array('dt_tl_id' => $loading["id"]));
                        if ($loading['is_saved'] == 0) {
                        ...
                        <tr class="text-nowrap <?php echo $rowColor; ?>">
                            <td class="">
                                <?php echo $loading["id"]; ?>
                                <a href="dt-maal-entry-add?id=<?php echo $loading['id']; ?>"
                            ...
                            <?php $bardana_qty = $per_wt = $total_wt = $empty_wt = $total_empty_wt = $saaf_wt = 0;

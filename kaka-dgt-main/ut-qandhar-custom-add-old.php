<?php include("header.php"); ?>
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h3 class="mb-3 mb-md-0 mt-n2 urdu-2">قندھار کسٹم کلئیرنگ انٹری</h3>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="ut-qandhar-custom.php"
    ...
    <div class="row">
        ...
        <?php if (isset($_GET['id'])) {
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post">
                                ...
                                <?php $border_json = json_decode($record['border_json']);
                                $borderJson = array(
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group flatpickr" id="flatpickr-date">
                                            ...
                                            <input value="<?php echo $borderJson['border_receiving_date']; ?>"
                                                   type="text" name="border_receiving_date"
            ...
            <?php } else {
                message('danger', 'ut-qandhar-custom.php', 'دوبارہ کوشش کریں');
            }
        } else {
            message('danger', 'ut-qandhar-custom.php', 'دوبارہ کوشش کریں');
        } ?>
...
<?php if (isset($_POST['recordUpdate'])) {
    ...
    $url = "ut-qandhar-custom-add.php?id=" . $hidden_id;
    $qandharArray= array(
    ...
    if ($done) {
        message('success', $url, 'قندھار کسٹم کلئیرنگ انٹری محفوظ ہوگئی ہے۔');
    } else {

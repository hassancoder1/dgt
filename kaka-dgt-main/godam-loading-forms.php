<?php include("header.php"); ?>
    <div class="heading-div d-flex justify-content-between align-items-center flex-wrap grid-margin px-4 py-1 border-bottom">
        <div>
            <h4 class="mb-3 mb-md-0">گودام لوڈنگ کرنے کے فارم</h4>
        </div>
                    ...
                    <div class="table-responsive scroll screen-ht">
                        <table class="table table-bordered " id="fix-head-table">
                            ...
                            <tr class="text-nowrap">
                                <!--<th width="17%">گودام کا نام</th>
                                <th width="14%">پتہ</th>
                                <th width="9%">شہر نام</th>
                                <th width="9%">گودام منشی کا نام</th>
                                <th width="12%">موبائل نمبر 1</th>
                                <th width="12%">موبائل نمبر 2</th>
                                <th width="12%">فون نمبر</th>
                                <th width="15%">مزید رپورٹ</th>-->
                                <th>گودام کا نام</th>
                                <th>پتہ</th>
                                <th>شہر نام</th>
                                <th>گودام منشی کا نام</th>
                                <th>موبائل نمبر 1</th>
                                <th>موبائل نمبر 2</th>
                                <th>فون نمبر</th>
                                <th>مزید رپورٹ</th>
                            ...
                            <tbody>
                            <?php $records = fetch('godam_loading_forms');
                            while ($record = mysqli_fetch_assoc($records)) { ?>
                                <tr>
                                    <td class="small urdu-td">
                                        <a href="godam-loading-form-add?id=<?php echo $record['id']; ?>">
                                    ...
                                    <!--<td>
                                        <a onclick="deleteRecord(this)" data-url="godam-loading-forms"

...
<?php if (isset($_GET['id']) && !empty($_GET['id']) && is_numeric($_GET['id']) && isset($_GET['type'])
    ...
    $urlArray = array('beopari-commission' => array('path' => 'imp-comp-beopari-comm', 'title' => ' بیوپاری کمیشن بل ', 'type' => ' بیوپاری کمیشن ', 'transfered_from' => 'beopari_commission', 'khaata_' => 'khaata_bc'));
            ...
            <div class="row gx-2">
                <div class="col-md-10">
                    ...
                    <?php if (empty($record[$page['khaata_']])) { ?>
                        <div class="card mt-2 border-top-0">
                            <form method="post">
                                ...
                                <div class="row gx-0 mb-2 mt-4 justify-content-center">
                                    <div class="col-lg-2">
                                        <div class="input-group">
                                            ...
                                            <small id="response1" class="top-0 left-0 text-danger urdu position-absolute"></small>
                                        </div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-group">
                                            ...
                                            <small id="response2" class="text-danger top-0 left-0 urdu position-absolute"></small>
                                        </div>
                    ...
                    <?php } else {
                        ...
                        $maal2 = isKirayaAdded(0, 'beopari_commission', $id);
                        if ($maal2['success']) {
...
<?php } else {
    echo '<script>window.location.href="imp-comp-beopari-comm";</script>';
} ?>
...
<?php if (isset($_POST['recordSubmitFinal'])) {
    ...
    if ($tl_id_hidden) {
        ...
        $maal2Added = insert('imp_truck_maals2', $maal2Data);
        if ($maal2Added) {

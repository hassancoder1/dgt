...
$pageURL = 'imp-maal-transfer-form-final';
...
<div
    ...
    <div>
        <h4>امپورٹ مال انٹری کو ٹرانسفر (مکمل)</h4>
    </div>
                ...
                <table class="table table-bordered table-sm" id="fix-head-table">
                    ...
                    while ($loading = mysqli_fetch_assoc($records)) {
                        ...
                        if (empty($loading['transfer_to_forms'])) {
                            continue; // dont show incomplete ones
                        } else {
                        ...
                        <tr class="text-nowrap">
                            ...
                            <td class="small-2"><?php echo $loading['driver_name']; ?>
                                <br><span dir="ltr"><?php echo $loading['driver_mobile']; ?></span>
                            </td>
                            <td>
                                ...
                                <form method="post">
                                    <div class="input-group d-flex">
                                        ...
                                        <button type="submit" name="transferToFormsSubmit"
                                                class="btn btn-outline-primary btn-sm py-0">محفوظ
                                        </button>
                                    </div>
                                </form>
                            </td>

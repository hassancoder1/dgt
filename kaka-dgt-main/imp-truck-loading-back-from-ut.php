...
$sql = "SELECT * FROM imp_truck_loadings WHERE is_transfered=0 AND is_ut_transferred=1  ";
if ($_POST) {
    $removeFilter = removeFilter('imp-truck-loading-back-from-ut');
...
///$sql = "SELECT * FROM imp_truck_loadings WHERE is_transfered=0 AND is_ut_transferred=1 {$username_append} {$date_append}";
...
<div class="heading-div d-flex justify-content-between align-items-center flex-wrap grid-margin px-4 py-1 border-bottom">
    <div>
        <h4 class="mb-3 mb-md-0">ٹرانزٹ واپسی امپورٹ ٹرک لوڈنگ</h4>
    </div>
                ...
                <div class="table-responsive scroll screen-ht">
                    <table class="table table-bordered " id="fix-head-table">
                        ...
                        <?php while ($loading = mysqli_fetch_assoc($records)) { ?>
                            <tr>
                                <td>
                                    <a href="imp-truck-loading-add?id=<?php echo $loading["id"]; ?>&type=ut"><?php echo $loading["id"]; ?></a>
                                </td>
                                ...
                                <td><?php echo $loading['driver_name']; ?>
                                ...
                                <td class="small"><?php echo $loading['report']; ?></td>
                                <?php if ($loading['is_transfered'] == 0 && $loading['godam_empty_id'] > 0 && $loading['truck_no'] != "") { ?>
                                    <td><a href="#" class="btn btn-primary py-0 px-1 small"

...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0">ایکسپورٹر کا اندراج </h4>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php if (isset($_GET['id'])) {
                    ...
                    $records = fetch('exporters', array('id' => $id));
                    ...
                    <form action="" method="post">
                        <div class="row gx-0 gy-2">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_name" class="input-group-text urdu">ایکسپورٹر کمپنی کا
                                            نام</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_mobile" class="input-group-text urdu">ایکسپورٹر کمپنی کا
                                            موبائل</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_email" class="input-group-text urdu">ایکسپورٹر کمپنی کا
                                            ای میل</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_city" class="input-group-text urdu">ایکسپورٹر کمپنی شہر
                                            کا نام</label>
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_address" class="input-group-text urdu">ایکسپورٹر کمپنی کا
                                            پتہ</label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_ntn" class="input-group-text urdu">ایکسپورٹر کمپنی کا این
                                            ٹی
                                            این</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_tax_no" class="input-group-text urdu">ایکسپورٹر کمپنی سیل
                                            ٹیکسٹ
                                            نمبر</label>
                        ...
                        <div class="d-flex mt-4 align-items-center justify-content-between">
                            ...
                            <div><?php echo addNew('exporter-add'); ?></div>
                        </div>
                    </form>
                <?php } else { ?>
                    <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <label for="comp_ntn" class="input-group-text urdu">ایکسپورٹر کمپنی کا این
                                            ٹی
                                            این</label>
                                        <input type="text" id="comp_ntn" name="comp_ntn" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
...
<?php if (isset($_POST['recordSubmit'])) {
    ...
    $done = insert('exporters', $data);
    if ($done) {
        $url .= '?id=' . $connect->insert_id;
        message('success', $url, 'ایکسپورٹر محفوظ ہوگیا');
    } else {
...
if (isset($_POST['recordUpdate'])) {
    ...
    $done = update('exporters', $data, array('id' => $hidden_id));
    if ($done) {
        message('info', $url, 'ایکسپورٹر تبدیل ہوگیا');
    } else {
        message('danger', $url, 'ڈیٹابیس پرابلم');
    }

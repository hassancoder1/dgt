...
$sql = "SELECT * FROM ut_bail_entries WHERE is_surrender = 1 AND karachi_user_ids IS NOT NULL ";
if ($_POST) {
    $removeFilter = removeFilter('ut-expense-karachi-bill');
            ...
            <div class="table-responsive scroll screen-ht">
                <table class="table table-bordered table-striped_ table-hover" id="fix-head-table">
                    ...
                    <?php while ($loading = mysqli_fetch_assoc($records)) {
                        ...
                        if (!empty($loading['khaata_karachi'])) { //condition: k kharcha daal dia h.
                            ...
                            <tr class="text-nowrap <?php echo $rowClass; ?>">
                                <td class="small-2">
                                    ...
                                    <a class="btn btn-primary pt-0 p-1 mt-n1 btn-sm float-end" data-tooltip="بل کا پرنٹ"
                                       ...
                                       href="print/ut-expense-bill?bail_id=<?php echo $loading["id"]; ?>&secret=<?php echo base64_encode("powered-by-upsol") ?>&start_date=<?php echo $print_start_date; ?>&end_date=<?php echo $print_end_date; ?>&type=<?php echo KARACHI; ?>&url=<?php echo base64_encode('ut-expense-karachi-bill') ?>"><i
                                                class="fa fa-print"></i>
                                    </a>
                                ...
                                <td class="small-2">
                                    <?php $khaata_ = json_decode($loading['khaata_' . KARACHI]);

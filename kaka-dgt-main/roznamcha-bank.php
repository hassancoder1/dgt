...
<div class="heading-div d-flex justify-content-between align-items-center flex-wrap grid-margin px-4 py-1 border-bottom">
    <div>
        <h4 class="mb-3 mb-md-0">بینک روزنامچہ
    ...
    <div class="d-flex align-items-center flex-wrap text-nowrap">
        ...
        <a href="roznamcha-bank-cheque" class="btn btn-dark pb-2 pt-1 me-2">بل کرنسی</a>
        <a href="roznamcha-bank-add" class="btn btn-outline-primary pb-2 pt-1">اندراج</a>
    </div>
</div>
                    ...
                    <table class="table table-bordered " id="fix-head-table">
                        ...
                        if (mysqli_num_rows($records) > 0) {
                            while ($roz = mysqli_fetch_assoc($records)) { ?>
                                <tr>
                                    <td><?php echo $roz['branch_serial']; ?>
                                        <!--<a href="roznamcha-bank-add.php?id=<?php /*echo $roz["r_id"]; */?>"></a>-->
                                    </td>
